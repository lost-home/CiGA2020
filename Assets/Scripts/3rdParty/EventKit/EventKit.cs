...
#pragma warning disable 0414
	...
	static public void Subscribe(string eventType, Callback handler)
	{
        ...
        var invocationList = eventTable[eventType]?.GetInvocationList();
        ...
        // 防止重复订阅
        else if (!invocationList.Contains(handler))
        {
            eventTable[eventType] = (Callback)eventTable[eventType] + handler;
        }
        else
        {
            //Debug.LogError($"Event is subscribed repeatedly! {eventType} {handler}");
        }
    }
