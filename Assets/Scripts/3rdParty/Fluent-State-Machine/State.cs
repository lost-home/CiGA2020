...
namespace RSG
{
    ...
    public interface IState
    {
        ...
        void ChangeState(System.Enum stateEnum);
        ...
        void PushState(System.Enum stateEnum);
    ...
    public abstract class AbstractState : IState
    {
        ...
        /// 栈顶状态
        /// </summary>
        public IState CurrentState => activeChildren.Count != 0 ? activeChildren.Peek() : null;
        ...
        public string CurrentStateStr
        {
            get
            {
                foreach (var kv in children)
                    if (kv.Value.Equals(CurrentState))
                        return kv.Key;
                return "Null";
            }
        }

        public Stack<IState> StateStack => activeChildren;
        ...
        public void ChangeState(string stateName)
        {
            ...
            //UnityEngine.Debug.Log($"AbstractState::ChangeState() {stateName}");
        }

        public void ChangeState(System.Enum stateEnum)
        {
            ChangeState(stateEnum.ToString());
        }
        ...
        public void PushState(System.Enum stateEnum)
        {
            PushState(stateEnum.ToString());
        }
        ...
        public string GetChildStateName(IState state)
        {
            foreach (var kv in children)
                if (kv.Value.Equals(state))
                    return kv.Key;
            return string.Empty;
        }
    }
