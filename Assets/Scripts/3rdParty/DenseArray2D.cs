...
public class DenseArray2D<T> : IEnumerable<T>
{
    ...
    public DenseArray2D(int rows, int columns)
    {
    ...
    public DenseArray2D(DenseArray2D<T> source)
    {
        ...
        _columnindexes = new int[Columns];
        Array.Copy(source._columnindexes, this._columnindexes, source._columnindexes.LongLength);
    }
